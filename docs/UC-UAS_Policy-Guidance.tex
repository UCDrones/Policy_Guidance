...
Starting in 2023, all drones and drone operations must be in compliance with 14 CFR 89 Remote Identification. This applies to all unmanned aircraft, including those operated for recreational or academic purposes. More information can be found on Chapter \ref{ch-remoteID}.
...
\hypertarget{registration-of-recreational-uas}{%
\section{Registration of Recreational UAS}\label{registration-of-recreational-uas}}
...
\textbf{Common Scenarios for Recreational Drones}
...
\hypertarget{the-recreational-uas-safety-test}{%
\section{The Recreational UAS Safety Test}\label{the-recreational-uas-safety-test}}
...
\hypertarget{ch-remoteID}{%
\chapter{Remote Identification}\label{ch-remoteID}}

Remote Identification or \protect\hyperlink{RID}{Remote ID} is a new requirement for drones. It will require most drones operating in US airspace to have remote ID capability. \protect\hyperlink{RID}{Remote ID} will provide information about drones in flight, such as the identity, location, and altitude of the drone and its control station or take-off location. Authorized individuals from public safety organizations may request identity of the drone's owner from the FAA.

Remote ID helps the FAA, law enforcement, and other federal agencies find the control station when a drone appears to be flying in an unsafe manner or where it is not allowed to fly. \protect\hyperlink{RID}{Remote ID} also lays the foundation of the safety and security groundwork needed for more complex drone operations.

\hypertarget{types-of-remote-id}{%
\section{Types of Remote ID}\label{types-of-remote-id}}

There are three ways that drone pilots will be able to meet the identification requirements of the \protect\hyperlink{RID}{Remote ID} regulations:
...
\hypertarget{standard-remote-id}{%
\subsection{Standard Remote ID}\label{standard-remote-id}}
...
\hypertarget{broadcast-remote-id}{%
\subsection{Broadcast Remote ID}\label{broadcast-remote-id}}
...
\hypertarget{faa-recognized-identification-areas}{%
\subsection{FAA Recognized Identification Areas}\label{faa-recognized-identification-areas}}

Drones without either Standard or Broadcast Remote ID will be restricted to operating only within FAA Recognized Identification Areas, or FRIAs. FRIAs are zones sponsored by \protect\hyperlink{CBO}{CBO} or an institute of higher education. Most campuses will have a FRIA available for use, pending FAA approval.
...
\textbf{While Standard Remote ID drones are not currently available, there is no benefit to delaying purchasing a drone for the sake of Standard Remote ID.}
...
\addcontentsline{toc}{subsubsection}{Low Altitude Authorization and Notification Capability}
...
\hypertarget{RID}{%
\subsubsection*{Remote Identification}\label{RID}}
\addcontentsline{toc}{subsubsection}{Remote Identification}

The term \protect\hyperlink{RID}{Remote ID} refers to the system required by the FAA for a drone in flight to provide identification and location information that can be received by other parties.
...
\hypertarget{TRUST}{%
\subsubsection*{The Recreational UAS Safety Test}\label{TRUST}}
\addcontentsline{toc}{subsubsection}{The Recreational UAS Safety Test}

The Recreational UAS Safety Test, or TRUST, is the aeronautical knowledge and safety exam developed by the FAA for all drone operators. The TRUST is free and available online. It can be taken at any of the administrators found on the FAA's website:
\url{https://www.faa.gov/uas/recreational_fliers/knowledge_test_updates/}
